...
class __LibraryPlaylistsState extends State<_LibraryPlaylists> {
  /* Scroll controller will know how far it will have to scroll down  for Scrollbar and listview*/
    ...
    return Expanded(
      child: Scrollbar(
        ...
        child: ListView(
          ...
          // Prevent bounce effect when user  scrolls at the top/bottom of the list
